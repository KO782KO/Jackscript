...
public class OpeningScreen extends javax.swing.JFrame {
    ...
    public OpeningScreen() {
        addComponentListener(java.awt.event.ComponentAdapter(){
	    public void componentResized(java.awt.event.ComponentEvent t){
	    setShape(new java.awt.geom.RoundRectangle2D.Double(0,0,getWidth(),getHeight(),10,10));
            }});
